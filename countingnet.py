...
from keras.layers import Input, Conv2D, MaxPooling2D, UpSampling2D, concatenate, multiply, BatchNormalization, Activation
from keras.models import Model
from keras.initializers import RandomNormal


def countingnet(input_shape=(None, None, 3), BN=False):
